...
export default function Footer() {
  return (
    <footer className="mt-10 border-t border-blue-200 bg-gradient-to-r from-blue-100 via-white to-indigo-100">
      <div className="mx-auto max-w-7xl px-4 py-5 text-center sm:px-6 sm:py-6">
        ...
        <div className="mt-2 flex flex-col items-center">
          ...
          <p className="mt-1.5 text-xs font-semibold text-slate-700 whitespace-nowrap sm:text-base">
