    ...
    <main className="min-h-screen bg-gradient-to-br from-slate-100 via-blue-50 to-indigo-100">
      ...
      <div className="max-w-7xl mx-auto px-8 py-8">
          ...
          <div className="relative flex justify-between items-start flex-wrap gap-6">
            ...
            <div className="flex gap-4">
              ...
              <Link href="/teachers/my-subjects">
                ...
                <div className="bg-white text-purple-700 hover:bg-slate-100 transition-all duration-300 px-6 py-3 rounded-2xl flex items-center gap-3 shadow-lg cursor-pointer">
        ...
        <div className="bg-white rounded-3xl shadow-xl p-6 mt-8">
          ...
          <div className="relative">
            ...
            <input
              ...
              className="w-full rounded-2xl border border-slate-300 py-4 pl-14 pr-4 outline-none focus:border-purple-600 focus:ring-4 focus:ring-purple-100 transition"
            />
        ...
        <div className="grid md:grid-cols-3 gap-6 mt-12">
          ...
          <div className="rounded-3xl bg-gradient-to-r from-purple-700 to-fuchsia-600 text-white p-7 shadow-xl">
